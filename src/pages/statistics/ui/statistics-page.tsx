...
import { useGetExamsList, useGetExamsStats } from "src/entities/exams"
...
export const StatisticsPage = () => {
	...
	const { data: exams, isLoading: examsLoading } = useGetExamsList()
	const { data: stats, isLoading, isFetching } = useGetExamsStats(exam, {
